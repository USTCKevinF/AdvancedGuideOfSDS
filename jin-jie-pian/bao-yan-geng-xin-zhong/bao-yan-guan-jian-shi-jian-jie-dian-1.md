...
* wl：waitlist，候补名单。
* 鸽穿：假设A院准备招100个学生，给100个学生发送了优营，给50个学生发了候补，到了保研时间的后期，优营里有80个学生都放了A院鸽子不来了，候补完50个学生还不够招生的100个指标，这个现象就叫鸽穿。
...
<figure><img src="../../.gitbook/assets/image (1) (1) (1).png" alt="" width="563"><figcaption><p>收到复试通知的界面</p></figcaption></figure>

<figure><img src="../../.gitbook/assets/image (3).png" alt="" width="563"><figcaption><p>复试通知详情界面</p></figcaption></figure>

* 在没有夏令营和预推免的时代，复试的考核都是在928之后一个月内完成的，也就是学生接受复试通知之后到十月底这段时间，招生单位需要安排考核选拔学生。考核通过后，便会向你发送预录取通知，学生可以选择是否接受（如下图）。

**由于只有一个月的时间来安排考核，所以招生单位发明了预推免，在928之前的一段时间内安排考核来提前筛选学生。学生通过考核之后就不用在928之后再进行复试了，大大减缓招生单位工作量。**

**但是预推免还不够，还有招生单位想要更早地招揽优秀生源，所以又发明了夏令营，在夏令营拿到offer和预推免的offer是等价的，都可以免去参与填报系统后的复试流程，直接得到招生单位发出的待录取通知。**

**到了现在，夏令营和预推免已经成为了招生单位进行招生的常态，很少有单位会在九推期间专门安排考核来考核学生，这时的复试考核可能更多是招生单位发现招不满学生后才紧急开展的考核**

<figure><img src="../../.gitbook/assets/image (4).png" alt="" width="563"><figcaption><p>待录取通知的详情界面</p></figcaption></figure>

* 点击接受后，正式上岸

<figure><img src="../../.gitbook/assets/4dd9f00f7589e35988249c7cb976983.png" alt="" width="563"><figcaption></figcaption></figure>
